...
private fun AriseWidgetContent(
    ...
    val crimsonColor = ColorProvider(Color(0xFFEF4444))
    val textPrimary = ColorProvider(Color(0xFFE2E8F0))
    val textDim = ColorProvider(Color(0xFF475569))
    ...
    Box(
        ...
        Column(
            ...
            Row(modifier = GlanceModifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
                Text(
                    "HP",
                    style = TextStyle(color = crimsonColor, fontSize = 9.sp, fontWeight = FontWeight.Bold)
                )
